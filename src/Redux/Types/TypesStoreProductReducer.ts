export const TypesStoreProductReducer =  {
    addProductsStore: '[TypesStoreProductReducer] ADD PRODUCTS STORE',
    removeProductsStore: '[TypesStoreProductReducer] REMOVE PRODUCTS STORE',
